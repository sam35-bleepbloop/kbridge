...
// ── prices/route.ts ──────────────────────────────────────────────────────────
writeFileSync(base + 'app/api/admin/prices/route.ts', `import { NextRequest, NextResponse } from 'next/server'
...
`, 'utf8');
console.log('✓ prices/route.ts rewritten');

// ── prices/[id]/route.ts ─────────────────────────────────────────────────────
writeFileSync(base + 'app/api/admin/prices/[id]/route.ts', `import { NextRequest, NextResponse } from 'next/server'
import { auth } from '@/lib/auth'
import { db } from '@/lib/db'
...
`, 'utf8');
console.log('✓ prices/[id]/route.ts rewritten');